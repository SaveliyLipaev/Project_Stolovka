...
namespace StolovkaWebAPI.IntegrationTests
{
    ...
    //        // Act
    //        var response = await TestClient.GetAsync(ApiRoutes.Canteens.GetAll);
    ...
    //        // Act
    //        var response = await TestClient.GetAsync(ApiRoutes.Canteens.Get.Replace("{postId}", createdPost.Id.ToString()));
